...
export default class VendorTearmscondition extends Component{
    constructor(props) {
        super(props);
          ...
          <View style={{paddingVertical:15,width:'70%'}}>
            {this.state.pagename==1 &&
                 ...
                 {this.state.pagename==0 &&
                  ...
                  <Text style={{color:'black',fontFamily:'Ubuntu-Medium',fontSize:15,textAlign:'center'}}>Terms Conditions & Privacy Policy</Text>
