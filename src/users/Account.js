...
export default class Account extends Component {
  ...
  getMyInboxAllData1 = async () => {
    ...
    if (userdata != null) {
      ...
      queryUpdatemyinbox.on('child_changed', data => {
        ...
        setTimeout(() => {
          this.setState({countinbox: count_inbox});
        }, 3000);
  ...
  vendorbecomebtn = async () => {
    ...
    if (this.state.isConnected === true) {
      ...
      var url =
        config.baseURL +
        'become_vendor_role.php?user_id=' +
        user_id +
        '&user_type=1';
      console.log('url:' + url);
      fetch(url, {
            ...
            <View style={{width: '15%', alignSelf: 'center'}}>
              {this.state.image == 'NA' ? (
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    this.state.image != 'NA'
                      ? this.props.navigation.navigate('Fullviewimage', {
                  ...
                  <Image
                    source={
                      this.state.login_type == 'app'
                        ? {uri: config.img_url1 + this.state.image}
        ...
        <ScrollView style={{marginBottom: 80}}>
          <View style={{backgroundColor: '#FFFFFF'}}>
            <TouchableOpacity
              ...
              <View
                ...
                <View style={{flexDirection: 'row'}}>
                  <Image
                    source={require('../icons/listing.png')}
                    style={{
                      alignSelf: 'center',
                      width: 22,
                      height: 20,
                ...
                <Image
                  source={require('../icons/side-arrow.png')}
                  style={{alignSelf: 'center', width: 13, height: 14}}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => {
                this.props.navigation.navigate('Myorderuser');
              }}>
              <View
                style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <View style={{flexDirection: 'row'}}>
            ...
            <TouchableOpacity
              ...
              <View
                ...
                <View style={{flexDirection: 'row'}}>
                  <Image
                    source={require('../icons/f-profile.png')}
                    style={{
                      alignSelf: 'center',
                      width: 22,
                      height: 20,
                ...
                <View style={{flexDirection: 'row'}}>
                  {notification_count_value > 0 && (
                    <View
                      ...
                      <Text
                        style={{color: '#FFFFFF', fontFamily: 'Ubuntu-Medium'}}>
                        {notification_count_value < 10
          ...
          <View style={{backgroundColor: '#FFFFFF', marginTop: 15}}>
            <TouchableOpacity
              ...
              <View style={{flexDirection: 'row'}}>
                <Image
                  source={require('../icons/invite-friend.png')}
                  style={{
                    alignSelf: 'center',
                    width: 22,
                    height: 20,
          ...
          <View style={{backgroundColor: '#FFFFFF', marginTop: 15}}>
            <TouchableOpacity
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                />
                <Text style={[styles.textfont, {color: Colors.buttoncolor}]}>
                  Log Out
                </Text>
              </View>
            </TouchableOpacity>
