...
export default class Userlogin extends Component {
  ...
  componentDidMount() {
    ...
    this.props.navigation.addListener('willFocus', payload => {
      ...
      if (
        payload.lastState.routeName == 'Userhome' &&
    ...
    GoogleSignin.configure({
      ...
      webClientId:
        '105582699491-m9la5ema2oue6i2m5lq3k2ecctoauh58.apps.googleusercontent.com',
    });
          ...
          if (obj.user_details.profile_complete == 0) {
            ...
            if (obj.notification_arr != 'NA') {
              notification.notificationfunction(
                obj.notification_arr[0].message,
                obj.notification_arr[0].action_json,
                obj.notification_arr[0].player_id,
                obj.notification_arr[0].title,
              );
            }
  ...
  Resendotpbtn = () => {
    ...
    Keyboard.dismiss();
    var url =
      config.baseURL + 'resend_otp.php?user_id=' + user_id + '&user_type=1';
    console.log('url', url);
    this.setState({
      loading: true,
      timer: null,
  ...
  Otpveryfication = () => {
    ...
    if (otp.length <= 0) {
      msgProvider.alert(
        msgTitle.error[config.language],
        'We have sent you a One Time Password to the contact details provided.Please check and enter the code to complete registration',
        false,
      );
      return false;
    }
      ...
      <View style={styles.container}>
          ...
          <TouchableOpacity
            ...
            <View
              ...
              <View style={{height: 'auto', width: '90%'}}>
                <TouchableOpacity
                  style={{width: '15%', alignSelf: 'flex-end', padding: 10}}
                  onPress={() => {
                    this.setState({
                      modalVisible: false,
                      timer: null,
                ...
                <Text
                  ...
                  We have sent you a One Time Password to the email details
                  provided.Please check and enter the code to complete
                  registration
                </Text>
        ...
        <ScrollView
          ...
          <View
            ...
            <TouchableOpacity
              style={{paddingVertical: 15, width: '10%', alignSelf: 'center'}}>
            ...
            <View style={{paddingVertical: 15, width: '70%'}}>
              <View style={{width: '100%', alignSelf: 'center'}}>
                <Image
                  source={require('../icons/b-logo.png')}
                  style={{
                    alignSelf: 'center',
          ...
          <View style={{paddingHorizontal: 20, paddingTop: 20}}>
            ...
            <Text
              ...
              Sign in with your email or social{'\n'}media account to continue
            </Text>

            <View style={styles.inputcontainer}>
              <View style={{alignSelf: 'center'}}>
                <Image
                  source={require('../icons/email2.png')}
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => {
                  this.remebermefunction();
                }}>
                {this.state.remeberme == false && (
              ...
              <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => {
                  this.props.navigation.navigate('Userforgatepassword');
                }}>
                <Text
                  style={{
                    color: Colors.buttoncolor,
            ...
            <TouchableOpacity
              ...
              style={[
                styles.button,
                {backgroundColor: Colors.buttoncolor, alignItems: 'center'},
              ]}>
              <View
                style={{
                  flexDirection: 'row',
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              style={[styles.button, {backgroundColor: '#347deb'}]}
              onPress={() => {
                this.FacebookLogin();
              }}>
