...
export default class Offersubmitted extends Component{
    constructor(props) {
        super(props);
...
return(
    <View style={styles.container}>
        ...
        <View style={{width:'100%',alignSelf:'center',flexDirection:'row',paddingTop:10}}>
         <TouchableOpacity style={{paddingVertical:15,width:'20%',alignSelf:'center'}} onPress={()=>{this.props.navigation.navigate('Userhome')}}> 
        ...
        <View style={{paddingHorizontal:20,paddingTop:30,flex:0.8,alignItems:'center',justifyContent:'center',alignContent:'center'}}>
          <View style={{width:'100%',alignSelf:'center'}}>
                 <Image source={require('../icons/submitted.png')} style={{alignSelf:'center',resizeMode:'contain',width:200,height:200,}}/>
             </View>
             <Text style={{color:'black',fontFamily:'Ubuntu-Bold',fontSize:20,paddingVertical:20}}>Order Submitted</Text>
<Text style={{color:'black',fontFamily:'Ubuntu-Medium',textAlign:'center',fontSize:13,alignSelf:'center',lineHeight:20}}>Thank you for order.{"\n"}your order is successful submitted{"\n"}you can see the information of your order in the my order section</Text>
        </View> 
       {/* ........................................Container finish............................... */}
