...
export default class Homecategorypage extends Component{
    constructor(props) {
        super(props);
        this.state = { 
          loading: false,
    ...
    getcatgorydata=async()=>{
      ...
      if(this.state.isConnected===true)
      {
       ...
       var url = config.baseURL+'get_item_by_category.php?user_id='+user_id+'&user_type=1&category_id='+this.state.cat_data.category_id;
       console.log("url:"+url);
      if(this.state.refresh==false)
      {
       ...
       console.log('obj',obj)
           if(obj.success == 'true'){
             this.setState({items_arr:obj.item_single_arr})
            } 
            else{
...
<Text style={{color:'black',fontFamily:'Ubuntu-Medium',fontSize:15,textAlign:'center'}}>{this.state.cat_data.category_name}</Text>
          </View>
          </View>
        {/* ..............................heaser finish................................ */}
     ...
     <FlatList
      ...
      renderItem={({item,index})=>{
        if(this.state.items_arr!='NA'){
            return(
            <View style={{width:'49%',alignSelf:'center',margin:1,paddingVertical:10,borderRadius:12}}>
