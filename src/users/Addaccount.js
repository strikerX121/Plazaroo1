...
import {Text,View,StyleSheet,Image,Dimensions,TextInput,BackHandler, ToastAndroid, Keyboard,ScrollView,TouchableOpacity,StatusBar} from 'react-native';
          ...
          fetch(url,{
             ...
             body:data,
              ...
              if(obj.success=='true')
              {
                ...
                this.props.navigation.navigate('Showaccount',{'bank_data':obj.bank_data})
              }
          else{
